...
== Disclaimer
  ...
  (The gem have no specs! OMG! 0nly manually tested under rails 3 and ruby 1.9.2)
...
== Credits and contributors
  ...
  * Jonas Nicklas (jnickals) who actually wrote most of the code while we pair-programmed.
